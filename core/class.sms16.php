<?php
	...
	class sms16 {
		 ...
		 * @param string $Server
		 */
		function __construct( $Token="56a1d48f6bf47b10cb2bffdf1e9b2cafd1d95c29", $Server = "https://xml.sms16.ru/xml/" ) {
			...
			if ( !empty( $Token ))
            {
				...
				throw new Exception( __METHOD__ . ' - Не указан параметр $Token' );
			}
		}
		...
		public function balance() {
			$Request = '<?xml version="1.0" encoding="utf-8"?><request><security><token value="' . $this->Token . '" /></security></request>';
		...
		public function incoming( $from, $to ) {
			$Request = '<?xml version="1.0" encoding="utf-8"?><request><security><token value="' . $this->Token . '" /></security><time start="' . date(
				'Y-m-d H:i:s', $from
		...
		public function state( $id_sms ) {
			...
			$Request = '<?xml version="1.0" encoding="utf-8"?><request><security><token value="' . $this->Token . '" /></security><get_state>';
		...
		public function send( $messages ) {
			...
			$Request = '<?xml version="1.0" encoding="utf-8"?><request><security><token value="' . $this->Token . '" /></security>';
